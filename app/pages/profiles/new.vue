  ...
  try {
    ...
    const created = await $fetch('/api/profiles', {
      ...
      body: {
        ...
        eyeColor: form.profileType === 'persona' ? resolvedEyeColor.value : undefined,
        ethnicity: form.profileType === 'persona' ? personalization.origin.trim() : undefined,
        particularities: form.profileType === 'persona' ? personalization.traits.trim() : undefined,
