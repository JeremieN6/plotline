...
function normalizeInfluencer(influencer) {
  ...
  return {
    ...
    gender: String(influencer?.gender || 'FEMALE'),
    ...
    eyeColor: typeof influencer?.eyeColor === 'string' ? influencer.eyeColor : null,
    ethnicity: typeof influencer?.ethnicity === 'string' ? influencer.ethnicity : null,
    particularities: typeof influencer?.particularities === 'string' ? influencer.particularities : null,
